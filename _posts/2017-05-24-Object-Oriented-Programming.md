...
title: "面向对象编程"
date: 2017-05-24
excerpt: "面向对象的思想主要是以对象为主，将一个问题抽象出具体的对象，并且将抽象出来的对象和对象的属性和方法封装成一个类。"
tags: [学习笔记, js, 面向对象]
comments: true
---
## 什么是面向对象编程
...
类的原型对象prototype对象的作用就是为类的原型添加共有方法的，但是类不能直接访问这些方法，只有将类实例化之后，新创建的对象复制了父类构造函数中的属性和方法，并将原型__proto__指向了父类的原型对象。这样子类就可以访问父类的public 和protected 的属性和方法，同时，父类中的private 的属性和方法不会被子类继承。
...
如果替换了prototype 对象，那么下一步必然是为心的prototype对象加上constructor属性，并将这个constructor属性指回原来的构造函数
